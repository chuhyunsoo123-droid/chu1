...
<head>
    ...
    <style>
        ...
        a { color: #000; text-decoration: none; font-size: 0.85em; margin-top: 20px; display: inline-block; border-bottom: 1px solid #000; }
    </style>
</head>
<body>
    <div class="container">
        <h2>REGISTER</h2>
        <form method="post">
            <input type="text" name="username" placeholder="CHOOSE ID" required>
